document.addEventListener("DOMContentLoaded", function() {
    ...
    var whatsappLinks = document.querySelectorAll("a.btn-get-started, a.boton-whatsapp, a#lead_whatsapp");
    ...
    whatsappLinks.forEach(function(link) {
        ...
        var mobileLink = "https://wa.me/573224736189?text=" + message;
        var desktopLink = "https://web.whatsapp.com/send?phone=573224736189&text=" + message;
